...
namespace fsm {
    ...
    public:
        ...
        bool click_yaw_en{};
        string cmd_topic, mpc_cmd_topic, click_goal_topic, waypoint_topic;
        double mission_waypoint_switch_distance{};
        double yaw_dot_max{};
        ...
        Config(const std::string & cfg_path) {
            ...
            loader.LoadParam("fsm/waypoint_topic", waypoint_topic,
                             string("/waypoint_generator/waypoints"));
            loader.LoadParam("fsm/mission_waypoint_switch_distance",
