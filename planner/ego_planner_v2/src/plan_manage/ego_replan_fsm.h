...
namespace ego_planner
{
  ...
  private:
    ...
    ros::Subscriber waypoint_sub_, waypoint_list_sub_, odom_sub_, trigger_sub_, broadcast_ploytraj_sub_, mandatory_stop_sub_;
    ...
    void RecvBroadcastMINCOTrajCallback(const quadrotor_msgs::MINCOTrajConstPtr &msg);
    void polyTraj2ROSMsg(quadrotor_msgs::PolyTraj &poly_msg, quadrotor_msgs::MINCOTraj &MINCO_msg);
