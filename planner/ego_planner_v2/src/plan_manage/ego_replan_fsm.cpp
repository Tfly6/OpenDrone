...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    broadcast_ploytraj_sub_ = nh.subscribe<quadrotor_msgs::MINCOTraj>("planning/broadcast_traj_recv", 100,
                                                                      &EGOReplanFSM::RecvBroadcastMINCOTrajCallback,
                                                                      this,
                                                                      ros::TransportHints().tcpNoDelay());

    poly_traj_pub_ = nh.advertise<quadrotor_msgs::PolyTraj>("planning/trajectory", 10);
  ...
  bool EGOReplanFSM::callEmergencyStop(Eigen::Vector3d stop_pos)
  {
    ...
    quadrotor_msgs::PolyTraj poly_msg;
    quadrotor_msgs::MINCOTraj MINCO_msg;
  ...
  void EGOReplanFSM::waypointCallback(const quadrotor_msgs::GoalSetPtr &msg)
  {
    if (msg->drone_id != planner_manager_->pp_.drone_id || msg->goal[2] < -0.1){
      ROS_ERROR("Received wrong goal for drone %d, ignored.", planner_manager_->pp_.drone_id);
      return;
    }
  ...
  void EGOReplanFSM::RecvBroadcastMINCOTrajCallback(const quadrotor_msgs::MINCOTrajConstPtr &msg)
  {
  ...
  void EGOReplanFSM::polyTraj2ROSMsg(quadrotor_msgs::PolyTraj &poly_msg, quadrotor_msgs::MINCOTraj &MINCO_msg)
  {
