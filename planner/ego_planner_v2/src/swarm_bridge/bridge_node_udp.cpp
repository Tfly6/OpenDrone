...
quadrotor_msgs::MINCOTraj MINCOTraj_msg_;
...
void one_traj_sub_udp_cb(const quadrotor_msgs::MINCOTrajPtr &msg)
{
...
int main(int argc, char **argv)
{
  ...
  one_traj_pub_ = nh.advertise<quadrotor_msgs::MINCOTraj>("/broadcast_traj_to_planner", 100);
