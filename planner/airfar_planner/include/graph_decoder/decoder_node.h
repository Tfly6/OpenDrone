...
#include <airfar_planner/VisGraph.h>
#include <airfar_planner/VisNode.h>
...
private:
    ...
    void GraphCallBack(const airfar_planner::VisGraphConstPtr& msg);
    ...
    void CreateNavNode(const airfar_planner::VisNode& msg, NavNodePtr& node_ptr);
    ...
    inline void ConvertGraphToMsg(const NodePtrStack& graph, airfar_planner::VisGraph& graph_msg) {
